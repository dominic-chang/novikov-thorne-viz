 ...
 */var Mp;function B_(){if(Mp)return ct;Mp=1;var o=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),a=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),f=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.iterator;function x(U){return U===null||typeof U!="object"?null:(U=v&&U[v]||U["@@iterator"],typeof U=="function"?U:null)}var y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,A={};function S(U,te,Ue){this.props=U,this.context=te,this.refs=A,this.updater=Ue||y}S.prototype.isReactComponent={},S.prototype.setState=function(U,te){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,te,"setState")},S.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function _(){}_.prototype=S.prototype;function I(U,te,Ue){this.props=U,this.context=te,this.refs=A,this.updater=Ue||y}var L=I.prototype=new _;L.constructor=I,T(L,S.prototype),L.isPureReactComponent=!0;var C=Array.isArray,Y=Object.prototype.hasOwnProperty,k={current:null},N={key:!0,ref:!0,__self:!0,__source:!0};function z(U,te,Ue){var K,ue={},Me=null,ve=null;if(te!=null)for(K in te.ref!==void 0&&(ve=te.ref),te.key!==void 0&&(Me=""+te.key),te)Y.call(te,K)&&!N.hasOwnProperty(K)&&(ue[K]=te[K]);var Te=arguments.length-2;if(Te===1)ue.children=Ue;else if(1<Te){for(var Ie=Array(Te),Ze=0;Ze<Te;Ze++)Ie[Ze]=arguments[Ze+2];ue.children=Ie}if(U&&U.defaultProps)for(K in Te=U.defaultProps,Te)ue[K]===void 0&&(ue[K]=Te[K]);return{$$typeof:o,type:U,key:Me,ref:ve,props:ue,_owner:k.current}}function P(U,te){return{$$typeof:o,type:U.type,key:te,ref:U.ref,props:U.props,_owner:U._owner}}function R(U){return typeof U=="object"&&U!==null&&U.$$typeof===o}function H(U){var te={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(Ue){return te[Ue]})}var oe=/\/+/g;function J(U,te){return typeof U=="object"&&U!==null&&U.key!=null?H(""+U.key):te.toString(36)}function fe(U,te,Ue,K,ue){var Me=typeof U;(Me==="undefined"||Me==="boolean")&&(U=null);var ve=!1;if(U===null)ve=!0;else switch(Me){case"string":case"number":ve=!0;break;case"object":switch(U.$$typeof){case o:case e:ve=!0}}if(ve)return ve=U,ue=ue(ve),U=K===""?"."+J(ve,0):K,C(ue)?(Ue="",U!=null&&(Ue=U.replace(oe,"$&/")+"/"),fe(ue,te,Ue,"",function(Ze){return Ze})):ue!=null&&(R(ue)&&(ue=P(ue,Ue+(!ue.key||ve&&ve.key===ue.key?"":(""+ue.key).replace(oe,"$&/")+"/")+U)),te.push(ue)),1;if(ve=0,K=K===""?".":K+":",C(U))for(var Te=0;Te<U.length;Te++){Me=U[Te];var Ie=K+J(Me,Te);ve+=fe(Me,te,Ue,Ie,ue)}else if(Ie=x(U),typeof Ie=="function")for(U=Ie.call(U),Te=0;!(Me=U.next()).done;)Me=Me.value,Ie=K+J(Me,Te++),ve+=fe(Me,te,Ue,Ie,ue);else if(Me==="object")throw te=String(U),Error("Objects are not valid as a React child (found: "+(te==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":te)+"). If you meant to render a collection of children, use an array instead.");return ve}function he(U,te,Ue){if(U==null)return U;var K=[],ue=0;return fe(U,K,"","",function(Me){return te.call(Ue,Me,ue++)}),K}function se(U){if(U._status===-1){var te=U._result;te=te(),te.then(function(Ue){(U._status===0||U._status===-1)&&(U._status=1,U._result=Ue)},function(Ue){(U._status===0||U._status===-1)&&(U._status=2,U._result=Ue)}),U._status===-1&&(U._status=0,U._result=te)}if(U._status===1)return U._result.default;throw U._result}var le={current:null},B={transition:null},ae={ReactCurrentDispatcher:le,ReactCurrentBatchConfig:B,ReactCurrentOwner:k};function re(){throw Error("act(...) is not supported in production builds of React.")}return ct.Children={map:he,forEach:function(U,te,Ue){he(U,function(){te.apply(this,arguments)},Ue)},count:function(U){var te=0;return he(U,function(){te++}),te},toArray:function(U){return he(U,function(te){return te})||[]},only:function(U){if(!R(U))throw Error("React.Children.only expected to receive a single React element child.");return U}},ct.Component=S,ct.Fragment=n,ct.Profiler=a,ct.PureComponent=I,ct.StrictMode=r,ct.Suspense=p,ct.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ae,ct.act=re,ct.cloneElement=function(U,te,Ue){if(U==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+U+".");var K=T({},U.props),ue=U.key,Me=U.ref,ve=U._owner;if(te!=null){if(te.ref!==void 0&&(Me=te.ref,ve=k.current),te.key!==void 0&&(ue=""+te.key),U.type&&U.type.defaultProps)var Te=U.type.defaultProps;for(Ie in te)Y.call(te,Ie)&&!N.hasOwnProperty(Ie)&&(K[Ie]=te[Ie]===void 0&&Te!==void 0?Te[Ie]:te[Ie])}var Ie=arguments.length-2;if(Ie===1)K.children=Ue;else if(1<Ie){Te=Array(Ie);for(var Ze=0;Ze<Ie;Ze++)Te[Ze]=arguments[Ze+2];K.children=Te}return{$$typeof:o,type:U.type,key:ue,ref:Me,props:K,_owner:ve}},ct.createContext=function(U){return U={$$typeof:f,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},U.Provider={$$typeof:u,_context:U},U.Consumer=U},ct.createElement=z,ct.createFactory=function(U){var te=z.bind(null,U);return te.type=U,te},ct.createRef=function(){return{current:null}},ct.forwardRef=function(U){return{$$typeof:d,render:U}},ct.isValidElement=R,ct.lazy=function(U){return{$$typeof:g,_payload:{_status:-1,_result:U},_init:se}},ct.memo=function(U,te){return{$$typeof:m,type:U,compare:te===void 0?null:te}},ct.startTransition=function(U){var te=B.transition;B.transition={};try{U()}finally{B.transition=te}},ct.unstable_act=re,ct.useCallback=function(U,te){return le.current.useCallback(U,te)},ct.useContext=function(U){return le.current.useContext(U)},ct.useDebugValue=function(){},ct.useDeferredValue=function(U){return le.current.useDeferredValue(U)},ct.useEffect=function(U,te){return le.current.useEffect(U,te)},ct.useId=function(){return le.current.useId()},ct.useImperativeHandle=function(U,te,Ue){return le.current.useImperativeHandle(U,te,Ue)},ct.useInsertionEffect=function(U,te){return le.current.useInsertionEffect(U,te)},ct.useLayoutEffect=function(U,te){return le.current.useLayoutEffect(U,te)},ct.useMemo=function(U,te){return le.current.useMemo(U,te)},ct.useReducer=function(U,te,Ue){return le.current.useReducer(U,te,Ue)},ct.useRef=function(U){return le.current.useRef(U)},ct.useState=function(U){return le.current.useState(U)},ct.useSyncExternalStore=function(U,te,Ue){return le.current.useSyncExternalStore(U,te,Ue)},ct.useTransition=function(){return le.current.useTransition()},ct.version="18.3.1",ct}var Ep;function Wf(){return Ep||(Ep=1,mc.exports=B_()),mc.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ap;function V_(){return Ap||(Ap=1,function(o){function e(B,ae){var re=B.length;B.push(ae);e:for(;0<re;){var U=re-1>>>1,te=B[U];if(0<a(te,ae))B[U]=ae,B[re]=te,re=U;else break e}}function n(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var ae=B[0],re=B.pop();if(re!==ae){B[0]=re;e:for(var U=0,te=B.length,Ue=te>>>1;U<Ue;){var K=2*(U+1)-1,ue=B[K],Me=K+1,ve=B[Me];if(0>a(ue,re))Me<te&&0>a(ve,ue)?(B[U]=ve,B[Me]=re,U=Me):(B[U]=ue,B[K]=re,U=K);else if(Me<te&&0>a(ve,re))B[U]=ve,B[Me]=re,U=Me;else break e}}return ae}function a(B,ae){var re=B.sortIndex-ae.sortIndex;return re!==0?re:B.id-ae.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var f=Date,d=f.now();o.unstable_now=function(){return f.now()-d}}var p=[],m=[],g=1,v=null,x=3,y=!1,T=!1,A=!1,S=typeof setTimeout=="function"?setTimeout:null,_=typeof clearTimeout=="function"?clearTimeout:null,I=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function L(B){for(var ae=n(m);ae!==null;){if(ae.callback===null)r(m);else if(ae.startTime<=B)r(m),ae.sortIndex=ae.expirationTime,e(p,ae);else break;ae=n(m)}}function C(B){if(A=!1,L(B),!T)if(n(p)!==null)T=!0,se(Y);else{var ae=n(m);ae!==null&&le(C,ae.startTime-B)}}function Y(B,ae){T=!1,A&&(A=!1,_(z),z=-1),y=!0;var re=x;try{for(L(ae),v=n(p);v!==null&&(!(v.expirationTime>ae)||B&&!H());){var U=v.callback;if(typeof U=="function"){v.callback=null,x=v.priorityLevel;var te=U(v.expirationTime<=ae);ae=o.unstable_now(),typeof te=="function"?v.callback=te:v===n(p)&&r(p),L(ae)}else r(p);v=n(p)}if(v!==null)var Ue=!0;else{var K=n(m);K!==null&&le(C,K.startTime-ae),Ue=!1}return Ue}finally{v=null,x=re,y=!1}}var k=!1,N=null,z=-1,P=5,R=-1;function H(){return!(o.unstable_now()-R<P)}function oe(){if(N!==null){var B=o.unstable_now();R=B;var ae=!0;try{ae=N(!0,B)}finally{ae?J():(k=!1,N=null)}}else k=!1}var J;if(typeof I=="function")J=function(){I(oe)};else if(typeof MessageChannel<"u"){var fe=new MessageChannel,he=fe.port2;fe.port1.onmessage=oe,J=function(){he.postMessage(null)}}else J=function(){S(oe,0)};function se(B){N=B,k||(k=!0,J())}function le(B,ae){z=S(function(){B(o.unstable_now())},ae)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(B){B.callback=null},o.unstable_continueExecution=function(){T||y||(T=!0,se(Y))},o.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<B?Math.floor(1e3/B):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_getFirstCallbackNode=function(){return n(p)},o.unstable_next=function(B){switch(x){case 1:case 2:case 3:var ae=3;break;default:ae=x}var re=x;x=ae;try{return B()}finally{x=re}},o.unstable_pauseExecution=function(){},o.unstable_requestPaint=function(){},o.unstable_runWithPriority=function(B,ae){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var re=x;x=B;try{return ae()}finally{x=re}},o.unstable_scheduleCallback=function(B,ae,re){var U=o.unstable_now();switch(typeof re=="object"&&re!==null?(re=re.delay,re=typeof re=="number"&&0<re?U+re:U):re=U,B){case 1:var te=-1;break;case 2:te=250;break;case 5:te=1073741823;break;case 4:te=1e4;break;default:te=5e3}return te=re+te,B={id:g++,callback:ae,priorityLevel:B,startTime:re,expirationTime:te,sortIndex:-1},re>U?(B.sortIndex=re,e(m,B),n(p)===null&&B===n(m)&&(A?(_(z),z=-1):A=!0,le(C,re-U))):(B.sortIndex=te,e(p,B),T||y||(T=!0,se(Y))),B},o.unstable_shouldYield=H,o.unstable_wrapCallback=function(B){var ae=x;return function(){var re=x;x=ae;try{return B.apply(this,arguments)}finally{x=re}}}}(vc)),vc}var Rp;function G_(){return Rp||(Rp=1,_c.exports=V_()),_c.exports}/**
 * @license React
...
`].filter(Oo).join(`
`)),f=Gf(f),f=Sm(f,n),f=ym(f,n),d=Gf(d),d=Sm(d,n),d=ym(d,n),f=Mm(f),d=Mm(d),n.isRawShaderMaterial!==!0&&(I=`#version 300 es
...
`)+`
`+_);const L=I+S+f,C=I+_+d,Y=_m(a,a.VERTEX_SHADER,L),k=_m(a,a.FRAGMENT_SHADER,C);a.attachShader(A,Y),a.attachShader(A,k),n.index0AttributeName!==void 0?a.bindAttribLocation(A,0,n.index0AttributeName):n.morphTargets===!0&&a.bindAttribLocation(A,0,"position"),a.linkProgram(A);function N(H){if(o.debug.checkShaderErrors){const oe=a.getProgramInfoLog(A).trim(),J=a.getShaderInfoLog(Y).trim(),fe=a.getShaderInfoLog(k).trim();let he=!0,se=!0;if(a.getProgramParameter(A,a.LINK_STATUS)===!1)if(he=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(a,A,Y,k);else{const le=xm(a,Y,"vertex"),B=xm(a,k,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(A,a.VALIDATE_STATUS)+`
