...
`].filter(Vo).join(`
`)),f=jf(f),f=wm(f,n),f=Am(f,n),d=jf(d),d=wm(d,n),d=Am(d,n),f=Rm(f),d=Rm(d),n.isRawShaderMaterial!==!0&&(N=`#version 300 es
...
`)+`
`+_);const L=N+S+f,C=N+_+d,X=Mm(a,a.VERTEX_SHADER,L),B=Mm(a,a.FRAGMENT_SHADER,C);a.attachShader(A,X),a.attachShader(A,B),n.index0AttributeName!==void 0?a.bindAttribLocation(A,0,n.index0AttributeName):n.morphTargets===!0&&a.bindAttribLocation(A,0,"position"),a.linkProgram(A);function F(U){if(o.debug.checkShaderErrors){const se=a.getProgramInfoLog(A).trim(),Y=a.getShaderInfoLog(X).trim(),fe=a.getShaderInfoLog(B).trim();let he=!0,oe=!0;if(a.getProgramParameter(A,a.LINK_STATUS)===!1)if(he=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(a,A,X,B);else{const le=Tm(a,X,"vertex"),z=Tm(a,B,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(A,a.VALIDATE_STATUS)+`
