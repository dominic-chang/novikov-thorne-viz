 ...
 */var Rp;function W_(){if(Rp)return ct;Rp=1;var o=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),a=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),f=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.iterator;function x(U){return U===null||typeof U!="object"?null:(U=v&&U[v]||U["@@iterator"],typeof U=="function"?U:null)}var y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,A={};function S(U,ie,Ue){this.props=U,this.context=ie,this.refs=A,this.updater=Ue||y}S.prototype.isReactComponent={},S.prototype.setState=function(U,ie){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,ie,"setState")},S.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function _(){}_.prototype=S.prototype;function I(U,ie,Ue){this.props=U,this.context=ie,this.refs=A,this.updater=Ue||y}var L=I.prototype=new _;L.constructor=I,T(L,S.prototype),L.isPureReactComponent=!0;var C=Array.isArray,X=Object.prototype.hasOwnProperty,k={current:null},N={key:!0,ref:!0,__self:!0,__source:!0};function Y(U,ie,Ue){var Z,ce={},Me=null,ve=null;if(ie!=null)for(Z in ie.ref!==void 0&&(ve=ie.ref),ie.key!==void 0&&(Me=""+ie.key),ie)X.call(ie,Z)&&!N.hasOwnProperty(Z)&&(ce[Z]=ie[Z]);var Te=arguments.length-2;if(Te===1)ce.children=Ue;else if(1<Te){for(var Ie=Array(Te),Ze=0;Ze<Te;Ze++)Ie[Ze]=arguments[Ze+2];ce.children=Ie}if(U&&U.defaultProps)for(Z in Te=U.defaultProps,Te)ce[Z]===void 0&&(ce[Z]=Te[Z]);return{$$typeof:o,type:U,key:Me,ref:ve,props:ce,_owner:k.current}}function P(U,ie){return{$$typeof:o,type:U.type,key:ie,ref:U.ref,props:U.props,_owner:U._owner}}function R(U){return typeof U=="object"&&U!==null&&U.$$typeof===o}function B(U){var ie={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(Ue){return ie[Ue]})}var ae=/\/+/g;function Q(U,ie){return typeof U=="object"&&U!==null&&U.key!=null?B(""+U.key):ie.toString(36)}function ee(U,ie,Ue,Z,ce){var Me=typeof U;(Me==="undefined"||Me==="boolean")&&(U=null);var ve=!1;if(U===null)ve=!0;else switch(Me){case"string":case"number":ve=!0;break;case"object":switch(U.$$typeof){case o:case e:ve=!0}}if(ve)return ve=U,ce=ce(ve),U=Z===""?"."+Q(ve,0):Z,C(ce)?(Ue="",U!=null&&(Ue=U.replace(ae,"$&/")+"/"),ee(ce,ie,Ue,"",function(Ze){return Ze})):ce!=null&&(R(ce)&&(ce=P(ce,Ue+(!ce.key||ve&&ve.key===ce.key?"":(""+ce.key).replace(ae,"$&/")+"/")+U)),ie.push(ce)),1;if(ve=0,Z=Z===""?".":Z+":",C(U))for(var Te=0;Te<U.length;Te++){Me=U[Te];var Ie=Z+Q(Me,Te);ve+=ee(Me,ie,Ue,Ie,ce)}else if(Ie=x(U),typeof Ie=="function")for(U=Ie.call(U),Te=0;!(Me=U.next()).done;)Me=Me.value,Ie=Z+Q(Me,Te++),ve+=ee(Me,ie,Ue,Ie,ce);else if(Me==="object")throw ie=String(U),Error("Objects are not valid as a React child (found: "+(ie==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":ie)+"). If you meant to render a collection of children, use an array instead.");return ve}function de(U,ie,Ue){if(U==null)return U;var Z=[],ce=0;return ee(U,Z,"","",function(Me){return ie.call(Ue,Me,ce++)}),Z}function $(U){if(U._status===-1){var ie=U._result;ie=ie(),ie.then(function(Ue){(U._status===0||U._status===-1)&&(U._status=1,U._result=Ue)},function(Ue){(U._status===0||U._status===-1)&&(U._status=2,U._result=Ue)}),U._status===-1&&(U._status=0,U._result=ie)}if(U._status===1)return U._result.default;throw U._result}var ue={current:null},z={transition:null},le={ReactCurrentDispatcher:ue,ReactCurrentBatchConfig:z,ReactCurrentOwner:k};function oe(){throw Error("act(...) is not supported in production builds of React.")}return ct.Children={map:de,forEach:function(U,ie,Ue){de(U,function(){ie.apply(this,arguments)},Ue)},count:function(U){var ie=0;return de(U,function(){ie++}),ie},toArray:function(U){return de(U,function(ie){return ie})||[]},only:function(U){if(!R(U))throw Error("React.Children.only expected to receive a single React element child.");return U}},ct.Component=S,ct.Fragment=n,ct.Profiler=a,ct.PureComponent=I,ct.StrictMode=r,ct.Suspense=p,ct.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=le,ct.act=oe,ct.cloneElement=function(U,ie,Ue){if(U==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+U+".");var Z=T({},U.props),ce=U.key,Me=U.ref,ve=U._owner;if(ie!=null){if(ie.ref!==void 0&&(Me=ie.ref,ve=k.current),ie.key!==void 0&&(ce=""+ie.key),U.type&&U.type.defaultProps)var Te=U.type.defaultProps;for(Ie in ie)X.call(ie,Ie)&&!N.hasOwnProperty(Ie)&&(Z[Ie]=ie[Ie]===void 0&&Te!==void 0?Te[Ie]:ie[Ie])}var Ie=arguments.length-2;if(Ie===1)Z.children=Ue;else if(1<Ie){Te=Array(Ie);for(var Ze=0;Ze<Ie;Ze++)Te[Ze]=arguments[Ze+2];Z.children=Te}return{$$typeof:o,type:U.type,key:ce,ref:Me,props:Z,_owner:ve}},ct.createContext=function(U){return U={$$typeof:f,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},U.Provider={$$typeof:u,_context:U},U.Consumer=U},ct.createElement=Y,ct.createFactory=function(U){var ie=Y.bind(null,U);return ie.type=U,ie},ct.createRef=function(){return{current:null}},ct.forwardRef=function(U){return{$$typeof:d,render:U}},ct.isValidElement=R,ct.lazy=function(U){return{$$typeof:g,_payload:{_status:-1,_result:U},_init:$}},ct.memo=function(U,ie){return{$$typeof:m,type:U,compare:ie===void 0?null:ie}},ct.startTransition=function(U){var ie=z.transition;z.transition={};try{U()}finally{z.transition=ie}},ct.unstable_act=oe,ct.useCallback=function(U,ie){return ue.current.useCallback(U,ie)},ct.useContext=function(U){return ue.current.useContext(U)},ct.useDebugValue=function(){},ct.useDeferredValue=function(U){return ue.current.useDeferredValue(U)},ct.useEffect=function(U,ie){return ue.current.useEffect(U,ie)},ct.useId=function(){return ue.current.useId()},ct.useImperativeHandle=function(U,ie,Ue){return ue.current.useImperativeHandle(U,ie,Ue)},ct.useInsertionEffect=function(U,ie){return ue.current.useInsertionEffect(U,ie)},ct.useLayoutEffect=function(U,ie){return ue.current.useLayoutEffect(U,ie)},ct.useMemo=function(U,ie){return ue.current.useMemo(U,ie)},ct.useReducer=function(U,ie,Ue){return ue.current.useReducer(U,ie,Ue)},ct.useRef=function(U){return ue.current.useRef(U)},ct.useState=function(U){return ue.current.useState(U)},ct.useSyncExternalStore=function(U,ie,Ue){return ue.current.useSyncExternalStore(U,ie,Ue)},ct.useTransition=function(){return ue.current.useTransition()},ct.version="18.3.1",ct}var Cp;function $f(){return Cp||(Cp=1,Sc.exports=W_()),Sc.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Lp;function q_(){return Lp||(Lp=1,function(o){function e(z,le){var oe=z.length;z.push(le);e:for(;0<oe;){var U=oe-1>>>1,ie=z[U];if(0<a(ie,le))z[U]=le,z[oe]=ie,oe=U;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var le=z[0],oe=z.pop();if(oe!==le){z[0]=oe;e:for(var U=0,ie=z.length,Ue=ie>>>1;U<Ue;){var Z=2*(U+1)-1,ce=z[Z],Me=Z+1,ve=z[Me];if(0>a(ce,oe))Me<ie&&0>a(ve,ce)?(z[U]=ve,z[Me]=oe,U=Me):(z[U]=ce,z[Z]=oe,U=Z);else if(Me<ie&&0>a(ve,oe))z[U]=ve,z[Me]=oe,U=Me;else break e}}return le}function a(z,le){var oe=z.sortIndex-le.sortIndex;return oe!==0?oe:z.id-le.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var f=Date,d=f.now();o.unstable_now=function(){return f.now()-d}}var p=[],m=[],g=1,v=null,x=3,y=!1,T=!1,A=!1,S=typeof setTimeout=="function"?setTimeout:null,_=typeof clearTimeout=="function"?clearTimeout:null,I=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function L(z){for(var le=n(m);le!==null;){if(le.callback===null)r(m);else if(le.startTime<=z)r(m),le.sortIndex=le.expirationTime,e(p,le);else break;le=n(m)}}function C(z){if(A=!1,L(z),!T)if(n(p)!==null)T=!0,$(X);else{var le=n(m);le!==null&&ue(C,le.startTime-z)}}function X(z,le){T=!1,A&&(A=!1,_(Y),Y=-1),y=!0;var oe=x;try{for(L(le),v=n(p);v!==null&&(!(v.expirationTime>le)||z&&!B());){var U=v.callback;if(typeof U=="function"){v.callback=null,x=v.priorityLevel;var ie=U(v.expirationTime<=le);le=o.unstable_now(),typeof ie=="function"?v.callback=ie:v===n(p)&&r(p),L(le)}else r(p);v=n(p)}if(v!==null)var Ue=!0;else{var Z=n(m);Z!==null&&ue(C,Z.startTime-le),Ue=!1}return Ue}finally{v=null,x=oe,y=!1}}var k=!1,N=null,Y=-1,P=5,R=-1;function B(){return!(o.unstable_now()-R<P)}function ae(){if(N!==null){var z=o.unstable_now();R=z;var le=!0;try{le=N(!0,z)}finally{le?Q():(k=!1,N=null)}}else k=!1}var Q;if(typeof I=="function")Q=function(){I(ae)};else if(typeof MessageChannel<"u"){var ee=new MessageChannel,de=ee.port2;ee.port1.onmessage=ae,Q=function(){de.postMessage(null)}}else Q=function(){S(ae,0)};function $(z){N=z,k||(k=!0,Q())}function ue(z,le){Y=S(function(){z(o.unstable_now())},le)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(z){z.callback=null},o.unstable_continueExecution=function(){T||y||(T=!0,$(X))},o.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<z?Math.floor(1e3/z):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_getFirstCallbackNode=function(){return n(p)},o.unstable_next=function(z){switch(x){case 1:case 2:case 3:var le=3;break;default:le=x}var oe=x;x=le;try{return z()}finally{x=oe}},o.unstable_pauseExecution=function(){},o.unstable_requestPaint=function(){},o.unstable_runWithPriority=function(z,le){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var oe=x;x=z;try{return le()}finally{x=oe}},o.unstable_scheduleCallback=function(z,le,oe){var U=o.unstable_now();switch(typeof oe=="object"&&oe!==null?(oe=oe.delay,oe=typeof oe=="number"&&0<oe?U+oe:U):oe=U,z){case 1:var ie=-1;break;case 2:ie=250;break;case 5:ie=1073741823;break;case 4:ie=1e4;break;default:ie=5e3}return ie=oe+ie,z={id:g++,callback:le,priorityLevel:z,startTime:oe,expirationTime:ie,sortIndex:-1},oe>U?(z.sortIndex=oe,e(m,z),n(p)===null&&z===n(m)&&(A?(_(Y),Y=-1):A=!0,ue(C,oe-U))):(z.sortIndex=ie,e(p,z),T||y||(T=!0,$(X))),z},o.unstable_shouldYield=B,o.unstable_wrapCallback=function(z){var le=x;return function(){var oe=x;x=le;try{return z.apply(this,arguments)}finally{x=oe}}}}(Ec)),Ec}var Dp;function j_(){return Dp||(Dp=1,Mc.exports=q_()),Mc.exports}/**
 * @license React
...
`)+`
`+_);const L=I+S+f,C=I+_+d,X=Mm(a,a.VERTEX_SHADER,L),k=Mm(a,a.FRAGMENT_SHADER,C);a.attachShader(A,X),a.attachShader(A,k),n.index0AttributeName!==void 0?a.bindAttribLocation(A,0,n.index0AttributeName):n.morphTargets===!0&&a.bindAttribLocation(A,0,"position"),a.linkProgram(A);function N(B){if(o.debug.checkShaderErrors){const ae=a.getProgramInfoLog(A).trim(),Q=a.getShaderInfoLog(X).trim(),ee=a.getShaderInfoLog(k).trim();let de=!0,$=!0;if(a.getProgramParameter(A,a.LINK_STATUS)===!1)if(de=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(a,A,X,k);else{const ue=Tm(a,X,"vertex"),z=Tm(a,k,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(A,a.VALIDATE_STATUS)+`
