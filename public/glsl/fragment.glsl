...
float calculateXC(float T) {
    if(T >= 1667.0 && T <= 4000.0) {
        return (-0.2661239 * (1e9 / pow(T, 3.0)) -
            0.2343589 * (1e6 / pow(T, 2.0)) +
            0.8776956 * (1e3 / T) +
            0.179910);
    } else if(T > 4000.0 && T <= 25000.0) {
        return (-3.0258469 * (1e9 / pow(T, 3.0)) +
...
float calculateYC(float T, float x_c) {
    if(T >= 1667.0 && T <= 2222.0) {
        return (-1.1063814 * pow(x_c, 3.0) -
            1.34811020 * pow(x_c, 2.0) +
            2.1855583 * x_c -
            0.20219683);
    } else if(T > 2222.0 && T <= 4000.0) {
        return (-0.9549476 * pow(x_c, 3.0) -
            1.37418593 * pow(x_c, 2.0) +
            2.09137015 * x_c -
            0.16748867);
    } else if(T > 4000.0 && T <= 25000.0) {
        return (3.0817580 * pow(x_c, 3.0) -
...
void main() {
    ...
    if(rs2 > 6.0 && enable_grav_lensing) {
        ...
        float rs_2=rs2*rs2;
        float theta2 = (SPEED/(rs_2*rs2))*theta - hor_rot;//
    ...
    if(rs1 > 6.0 && enable_grav_lensing) {
        ...
        float rs_2=rs1*rs1;
        float theta2 = (SPEED/(rs_2*rs1))*theta - hor_rot;//
    ...
    if(rs > 6.0) {
        ...
        float rs_2=rs*rs;
        float theta2 = (SPEED/(rs_2*rs))*theta - hor_rot;//
